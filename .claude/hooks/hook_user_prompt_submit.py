...
# Also persist the turn start time: hook_stop uses it as the turn-root span start.
turn_id = str(uuid.uuid4())
write_state(f"claude_turn_{session_id}.id", turn_id)
write_state(f"claude_turn_{session_id}.start_ns", str(now))
